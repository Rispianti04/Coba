                ...
                <tr>
                    ...
                    <td>
                        <div class="btn-group" roles="group" aria-label="Basic Example">
                            <button type="button" id="btn-edit-closes" class="btn" data-toggle="modal" data-target="#modalEdit" data-id="{{ $key->id }}" data-name="{{ $key->name }}" data-tanggal="{{ $key->tanggal }}" data-jumlah="{{ $key->jumlah }}"><i class="fa fa-edit"></i></button>
                            <button type="button" id="btn-delete-closes" class="btn" data-toggle="modal" data-target="#modalDeleteData" data-id="{{ $key->id }}" data-name="{{$key->name}}"><i class="fa fa-trash"></i></button>
                        </div>
                    </td>
                </tr>
                @endforeach
...
<div class="modal-body">
    <form method="post" action="{{ route('admin.keluar.submit') }}" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <p style="font-style: italic;">*Note: Format Date 2021-03-04</p>
        </div>
</div>
